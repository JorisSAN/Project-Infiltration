...
namespace utils.runtime
{
    public static class ExtString
    {
        ...
        public static bool ContainsIgnoreCase(this string sources, string toCheck)
        {
            return (ContainsWithCulturTest(sources, toCheck, StringComparison.OrdinalIgnoreCase));
        }

        public static bool ContainsWithCulturTest(string source, string toCheck, StringComparison comp)
        {
